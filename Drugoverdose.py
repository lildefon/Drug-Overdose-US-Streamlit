...
# Reading in the data &url 
url = "https://raw.githubusercontent.com/lildefon/Drug-Overdose-US-Streamlit/main/Data/accurate_provisional.csv"
provisional_death = pd.read_csv(url)
#Layout
st.set_page_config(
...
#adding Image: 
st.image('Data/images/drug1.jpeg', use_column_width=True, width=200)
...
with source_tab: 
    ...
    st.image('Data/images/vsrrimage.jpeg')
