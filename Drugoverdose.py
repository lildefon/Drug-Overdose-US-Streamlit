...
provisional_death = pd.read_csv("data/accurate_provisional.csv")
#Layout
st.set_page_config(
...
#adding Image: 
st.image('image/drug1.jpeg', use_column_width=True, width=200)
...
with Analysis_tab:
    ...
    ### LINE CHART FOR THE NATIONAL US ACTUAL DEATH VS PREDICTED  
